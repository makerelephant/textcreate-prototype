...
export function isStopKeyword(s: string) { return ["STOP", "UNSUBSCRIBE", "CANCEL", "END", "QUIT"].includes(s.toUpperCase()); }
export function isHelpKeyword(s: string) { return ["HELP", "INFO"].includes(s.toUpperCase()); }
